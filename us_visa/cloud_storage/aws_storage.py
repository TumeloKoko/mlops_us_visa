...
class SimpleStorageService:
    ...
    def read_object(object_name: str, decode: bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        ...
        """
        logging = LoggerManager(__name__).get_logger()
    ...
    def get_bucket(self, bucket_name: str) -> Bucket:
        ...
        Revisions   :   moved setup to cloud
        """
        self.logging.info("Entered the get_bucket method of S3Operations class")

        try:
            bucket = self.s3_resource.Bucket(bucket_name)
            self.logging.info("Exited the get_bucket method of S3Operations class")
            return bucket
        except Exception as e:
            raise USvisaException(e, sys) from e
    ...
    def get_file_object( self, filename: str, bucket_name: str) -> Union[List[object], object]:
        ...
        Revisions   :   moved setup to cloud
        """
        self.logging.info("Entered the get_file_object method of S3Operations class")
        ...
        try:
            ...
            self.logging.info("Exited the get_file_object method of S3Operations class")
    ...
    def load_model(self, model_name: str, bucket_name: str, model_dir: str = None) -> object:
        ...
        Revisions   :   moved setup to cloud
        """
        self.logging.info("Entered the load_model method of S3Operations class")
        ...
        try:
            ...
            self.logging.info("Exited the load_model method of S3Operations class")
            return model
    ...
    def create_folder(self, folder_name: str, bucket_name: str) -> None:
        ...
        Revisions   :   moved setup to cloud
        """
        self.logging.info("Entered the create_folder method of S3Operations class")
        ...
        try:
            ...
            if e.response["Error"]["Code"] == "404":
                ...
                pass
            self.logging.info("Exited the create_folder method of S3Operations class")
    ...
    def upload_file(self, from_filename: str, to_filename: str,  bucket_name: str,  remove: bool = True):
        ...
        Revisions   :   moved setup to cloud
        """
        self.logging.info("Entered the upload_file method of S3Operations class")
        ...
        try:
            ...
            if remove is True:
                ...
                self.logging.info(f"Remove is set to {remove}, deleted the file")

            else:
                self.logging.info(f"Remove is set to {remove}, not deleted the file")

            self.logging.info("Exited the upload_file method of S3Operations class")
    ...
    def upload_df_as_csv(self,data_frame: DataFrame,local_filename: str, bucket_filename: str,bucket_name: str,) -> None:
        ...
        Revisions   :   moved setup to cloud
        """
        self.logging.info("Entered the upload_df_as_csv method of S3Operations class")
        ...
        try:
            ...
            self.logging.info("Exited the upload_df_as_csv method of S3Operations class")
    ...
    def get_df_from_object(self, object_: object) -> DataFrame:
        ...
        Revisions   :   moved setup to cloud
        """
        self.logging.info("Entered the get_df_from_object method of S3Operations class")

        try:
            content = self.read_object(object_, make_readable=True)
            df = read_csv(content, na_values="na")
            self.logging.info("Exited the get_df_from_object method of S3Operations class")
            return df
        except Exception as e:
            raise USvisaException(e, sys) from e
    ...
    def read_csv(self, filename: str, bucket_name: str) -> DataFrame:
        ...
        Revisions   :   moved setup to cloud
        """
        self.logging.info("Entered the read_csv method of S3Operations class")

        try:
            csv_obj = self.get_file_object(filename, bucket_name)
            df = self.get_df_from_object(csv_obj)
            self.logging.info("Exited the read_csv method of S3Operations class")
            return df
        except Exception as e:
            raise USvisaException(e, sys) from e
